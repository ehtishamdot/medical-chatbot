...
export async function POST(req: NextRequest) {
  try {
    ...
    const apiUrl = `https://9db0-2407-aa80-14-6ae2-cc6b-aa0a-6acd-2a10.ngrok-free.app/api/bot/question?specialist=${specialist}&specificity=${specificity}&disease=${disease}`;
